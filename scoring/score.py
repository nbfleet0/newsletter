...
def calculateScore(object):
    ...
    # object: [cb url, url, funding, name]
	print(object[0])
...
# print(calculateScore(["http://www.crunchbase.com/organization/parallel-universe","http://paralleluniverse.co","$7.4M","Parallel Universe"])) #good
# calculateScore(["", "http://www.crunchbase.com/organization/priime","","priime","http://priime.com/","","","",""]) #good
#calculateScore(["", "http://www.crunchbase.com/organization/taskpipes","","taskpipes","http://taskpipes.com/","","","",""]) #good
